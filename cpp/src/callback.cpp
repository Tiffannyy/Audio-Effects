...
void processBlock(const SAMPLE* in, SAMPLE* out,
    ...
    for(unsigned long i = 0; i < framesPerBuffer; i++){
        ...
        // Tremolo effect
            ...
            ud->params->TREM_PHASE += ud->tremIncrement;
        ...
        // Reverb
            ...
            for (int tap = 0; tap < AudioParams::REVERB_TAPS; tap++){
                ...
                ud->reverbBuffer[ud->reverbIndex[tap]] = inFloatL + feedbackSum * ud->params->REVERB_DECAY;
	        }

            ud->reverbBuffer[ud->reverbIndex[0]] = inFloatL + feedbackSum * ud->params->REVERB_DECAY;
